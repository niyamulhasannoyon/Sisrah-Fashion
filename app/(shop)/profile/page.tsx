      ...
      <div className="w-full md:w-64 flex flex-col gap-3">
        ...
        <div className="bg-gray-900 p-5 md:p-6 rounded-xl md:rounded-lg text-white flex md:flex-col items-center md:text-center gap-4 md:gap-3">
          <div className="relative w-12 h-12 md:w-16 md:h-16 shrink-0">
            {user.image ? (
              <Image src={user.image} alt={user.name} fill sizes="64px" className="rounded-full object-cover border-2 border-white/20 shadow-sm" />
            ) : (
          ...
          <form onSubmit={handleSaveProfile} className="animate-in fade-in duration-500 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 pb-5 sm:pb-6 border-b border-gray-100">
              <div className="relative w-16 h-16 sm:w-20 sm:h-20 shrink-0">
                {user.image ? (
                  <Image src={user.image} alt={user.name} fill sizes="80px" className="rounded-full object-cover border shadow-sm" />
                ) : (
                      ...
                      {order.orderItems.map((item: any, idx: number) => (
                        <div key={idx} className="flex items-center justify-between gap-2">
                          <div className="flex items-center gap-2.5 min-w-0">
                            <div className="relative w-8 h-8 sm:w-10 sm:h-10 bg-white border border-gray-100 rounded-lg overflow-hidden shrink-0">
