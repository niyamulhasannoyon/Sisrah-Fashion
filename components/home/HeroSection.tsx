...
export function HeroSection({ initialSettings }: HeroSectionProps) {
  ...
  const slides: ImageAsset[] = settings?.heroImages && settings.heroImages.length > 0
    ? settings.heroImages
  ...
  return (
    <section className="relative w-full bg-surface-dark text-white py-10 lg:py-0 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-fit lg:min-h-[calc(100vh-80px)] flex flex-col justify-center">
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-brand/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl w-full py-4 lg:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          <div className="lg:col-span-7 flex flex-col items-start text-left space-y-6 z-10 py-2 sm:py-4">
            ...
            <h1 className="text-2xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-white leading-snug sm:leading-tight lg:leading-[1.18] font-bengali">
              {headline}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 w-full sm:w-auto pt-2">
              <Link
                href="/shop"
                className="inline-flex items-center justify-center gap-2.5 bg-brand hover:bg-brand-dark text-white font-bold text-xs sm:text-sm px-7 py-3.5 rounded-xl tracking-wider uppercase shadow-glow transition-all duration-200 active:scale-[0.98]"
              >
            ...
            <div className="pt-4 border-t border-white/10 w-full grid grid-cols-3 gap-2 text-gray-300 font-bengali text-[11px] sm:text-xs">
              ...
              <div className="flex items-center gap-1.5">
                <RefreshCw size={14} className="text-brand shrink-0" />
          ...
          <div className="lg:col-span-5 relative w-full h-[380px] sm:h-[480px] lg:h-[540px] xl:h-[580px]">
            <motion.div
              className="relative w-full h-full rounded-2xl sm:rounded-3xl overflow-hidden border border-white/15 shadow-2xl bg-editorial-dark group cursor-grab active:cursor-grabbing"
              drag="x"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute bottom-4 left-4 right-4 p-3 bg-black/40 backdrop-blur-md rounded-xl border border-white/10 flex items-center justify-between text-xs text-white">
                        <span className="font-bold tracking-wider uppercase text-[10px] sm:text-xs">Premium Craftsmanship</span>
