...
export function CategoryGrid() {
  ...
  return (
    <section className="bg-surface-subtle/50 py-16 lg:py-24 border-t border-neutral-200/60">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 lg:mb-12 flex flex-col gap-2 text-center">
          <span className="text-[10px] sm:text-xs uppercase tracking-[0.25em] text-brand font-bold">
            FEATURED CATEGORIES
          </span>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-neutral-900 font-bengali">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          {categories.map((category, index) => (
            ...
            >
              <Link
                href={category.href}
                className={`group relative h-[220px] md:h-[420px] overflow-hidden rounded-2xl bg-editorial-dark shadow-subtle hover:shadow-elevated transition-all duration-300 block ${
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-5 md:p-7 text-white z-10">
                  <div>
                    <span className="text-[10px] md:text-xs uppercase tracking-[0.2em] text-brand font-bold">
                      {category.title}
                    </span>
                  ...
                  <div className="flex items-center gap-1.5 text-[10px] md:text-xs uppercase tracking-widest font-bold text-white border-b border-white/40 pb-1 self-start group-hover:border-brand group-hover:text-brand transition-all duration-300">
