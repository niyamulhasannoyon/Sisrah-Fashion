        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 mt-2">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#27272A] hover:bg-loomra-red text-[#D4D4D8] hover:text-white rounded-full transition-colors duration-300">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.75z" />
                </svg>
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#27272A] hover:bg-loomra-red text-[#D4D4D8] hover:text-white rounded-full transition-colors duration-300">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3.5 text-xs text-[#A1A1AA]">
              ...
              <li className="flex gap-2 items-center">
                ...
                <span>support@assidrat.com</span>
              </li>
