  ...
  return (
    <footer className="border-t border-slate-100 bg-[#0F0F10] text-[#E4E4E7] pt-16 pb-[max(8rem,env(safe-area-inset-bottom))] md:pb-12">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 mt-2">
              <a href={settings?.facebookUrl || "https://facebook.com"} aria-label="Facebook" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#27272A] hover:bg-loomra-red text-[#D4D4D8] hover:text-white rounded-full transition-colors duration-300">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.75z" />
                </svg>
              </a>
              <a href={settings?.instagramUrl || "https://instagram.com"} aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#27272A] hover:bg-loomra-red text-[#D4D4D8] hover:text-white rounded-full transition-colors duration-300">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {settings?.youtubeUrl && (
                <a href={settings.youtubeUrl} aria-label="YouTube" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#27272A] hover:bg-loomra-red text-[#D4D4D8] hover:text-white rounded-full transition-colors duration-300">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2.5 text-xs text-[#A1A1AA]">
              ...
              <li><Link href="/shop" className="hover:text-white transition-colors">All New Arrivals</Link></li>
              <li><Link href="/community" className="hover:text-white transition-colors">Community Gallery</Link></li>
            </ul>
          </div>
        ...
        {/* Footer Bottom Bar */}
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6 text-[11px] text-[#A1A1AA]">
